...
| --- | --- | --- | --- | --- | --- | --- |
| D001 | High | Service boundary | `ai-orchestration-service` hosts too many domains | Phase 001 split controller classes; Phase 002 split internal query service ownership; Phase 005 selected next-governance-horizon modular monolith; Phase 008 documented per-domain transition-host exit criteria and readiness gates, but the service host still contains multiple domains | Use the Phase 008 inventory before any extraction, route migration or permanence claim; select follow-up domain readiness work only through Window 0 and human approval | Open - Phase 008 added exit criteria/readiness inventory, transition-host debt remains |
...
Next work should use the Phase 008 inventory to score bounded follow-up phases, such as report boundary readiness, market/data-ingest ownership, risk/strategy projection ownership, auth/gateway, legacy route migration or config-store decisions.
