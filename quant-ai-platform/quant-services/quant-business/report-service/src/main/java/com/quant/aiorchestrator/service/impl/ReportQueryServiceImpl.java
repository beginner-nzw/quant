...
public class ReportQueryServiceImpl implements ReportQueryService {
    ...
    private final ReportCenterProjectionManager reportCenterProjectionManager;
    private final TaskReportProjectionProvider taskReportProjectionProvider;
    private final ReportReviewStatsManager reportReviewStatsManager;
    ...
    public ReportCenterPageVO pageReportCenter(ReportCenterPageQueryDTO queryDTO) {
        return reportCenterProjectionManager.pageReportCenter(queryDTO);
    }

    @Override
    public ReportCenterStatsVO getReportCenterStats() {
        return reportCenterProjectionManager.getReportCenterStats();
    }

    @Override
    public TaskReportVO getTaskReportOnly(String taskId) {
        return taskReportProjectionProvider.getTaskReportOnly(taskId);
    }
    ...
    public ReportReviewStatsVO getReportReviewStats() {
        return reportReviewStatsManager.getReportReviewStats();
    }
}
