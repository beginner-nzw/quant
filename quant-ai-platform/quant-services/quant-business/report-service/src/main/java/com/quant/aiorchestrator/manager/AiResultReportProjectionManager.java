...
public class AiResultReportProjectionManager implements AiResultReportProjectionService {
    ...
    @Override
    public void saveReportProjection(AiTaskResultMessage message, ResearchReportSnapshot report) {
        saveReportEvidenceRefs(message, report);
        saveReportSections(message, report);
    }

    private void saveReportEvidenceRefs(AiTaskResultMessage message, ResearchReportSnapshot report) {
    ...
    private void saveReportSections(AiTaskResultMessage message, ResearchReportSnapshot report) {
        AiTaskResultMessage.ResultPayload payload = message.getPayload();
