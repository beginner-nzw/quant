...
public class ReportCenterItemAssembler {
    ...
    public ReportCenterListItemVO toReportCenterItem(ResearchReportDO report,
                                                     ReportCenterTaskProjection task,
                                                     ReportCenterRiskProjection warning) {
    ...
    private String resolveReportType(ResearchReportDO report, ReportCenterTaskProjection task) {
    ...
    private boolean isDomainRiskHumanReview(ReportCenterRiskProjection warning) {
        if (warning == null) {
            return false;
        }
    ...
    private RiskLevelEnum resolveDomainRiskLevel(ReportCenterRiskProjection warning) {
