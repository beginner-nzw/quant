...
public class AuditComplianceQueryServiceImpl implements AuditComplianceQueryService {
    ...
    private final AuditComplianceProjectionManager auditComplianceProjectionManager;

    @Override
    public AuditCompliancePageVO pageAuditCompliance(AuditCompliancePageQueryDTO queryDTO) {
        return auditComplianceProjectionManager.pageAuditCompliance(queryDTO);
    }

    @Override
    public AuditComplianceStatsVO getAuditComplianceStats() {
        return auditComplianceProjectionManager.getAuditComplianceStats();
    }
}
