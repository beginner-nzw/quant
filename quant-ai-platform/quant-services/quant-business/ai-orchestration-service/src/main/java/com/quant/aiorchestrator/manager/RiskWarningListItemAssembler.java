...
public class RiskWarningListItemAssembler {
    ...
    public RiskWarningListItemAssembler(StrategySignalRuleManager ruleManager) {
    ...
    public RiskWarningListItemVO toRiskWarningItem(RiskWarningDO warning,
        ...
        StrategySignalRuleManager.RiskProjection riskProjection = ruleManager.resolveRiskProjection(report, warning, details);
    ...
    public RiskWarningListItemVO toRiskWarningItem(ResearchReportDO report,
                                                   ResearchTaskDO task,
                                                   FollowUpTaskSummaryManager.FollowUpSummary followUpSummary) {
