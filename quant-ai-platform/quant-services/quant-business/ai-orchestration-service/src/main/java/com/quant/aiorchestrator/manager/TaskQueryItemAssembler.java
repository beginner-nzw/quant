...
public class TaskQueryItemAssembler {
    ...
    public TaskListItemVO toTaskListItemVO(ResearchTaskDO task, ResearchReportDO report) {
    ...
    public WorkflowInstanceVO toWorkflowInstanceVO(AiWorkflowInstanceDO entity) {
        WorkflowInstanceVO vo = new WorkflowInstanceVO();
        BeanUtils.copyProperties(entity, vo);
        return vo;
    }

    public AgentExecutionVO toAgentExecutionVO(AiAgentExecutionDO entity) {
        AgentExecutionVO vo = new AgentExecutionVO();
        BeanUtils.copyProperties(entity, vo);
        return vo;
    }

    public AuditRecordVO toAuditRecordVO(AuditRecordDO entity) {
