...
public class TaskQueryController {
    ...
    public Result<String> retryTask(@PathVariable("taskId") String taskId,
        ...
        taskRoleAccessService.requirePermission(TaskRoleAccessService.PERMISSION_TASK_RETRY);
    ...
    public Result<String> cancelTask(@PathVariable("taskId") String taskId,
        ...
        taskRoleAccessService.requirePermission(TaskRoleAccessService.PERMISSION_TASK_CANCEL);
