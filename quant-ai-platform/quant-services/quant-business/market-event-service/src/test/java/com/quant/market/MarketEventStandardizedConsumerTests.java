...
class MarketEventStandardizedConsumerTests {
    ...
    void pendingEventShouldExecuteAndRecordConsumed() throws Exception {
        ...
        when(taskMessageLogService.beginConsume(KafkaTopicConstants.MARKET_EVENT_STANDARDIZED, message, "market-event-service")).thenReturn(true);
        ...
        verify(taskMessageLogService).recordConsumed(KafkaTopicConstants.MARKET_EVENT_STANDARDIZED, message, "market-event-service");
        verify(taskMessageLogService, never()).recordSkipped(eq(KafkaTopicConstants.MARKET_EVENT_STANDARDIZED), any(), eq("market-event-service"), any());
    }
    ...
    private MarketEventStandardizedMessage buildMessage() {
        ...
        message.setSourceService("market-event-service");
