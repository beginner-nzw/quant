...
class MarketEventAutoTriggerServiceTests {
    ...
    void prepareAutoTriggerShouldPersistWillTriggerWhenRuleMatched() {
        ...
        EventAutoTriggerConfigPort.EventAutoTriggerConfig config = new EventAutoTriggerConfigPort.EventAutoTriggerConfig();
        config.setEnabled(true);
        EventAutoTriggerConfigPort.EventAutoTriggerRule rule = new EventAutoTriggerConfigPort.EventAutoTriggerRule();
    ...
    void executePendingAutoTriggerShouldPersistSuccessTaskId() {
        ...
        EventAutoTriggerConfigPort.EventAutoTriggerRule rule = fixture.rule("HIGH_IMPACT");
        when(fixture.configService.findEnabledRuleByCode("HIGH_IMPACT")).thenReturn(rule);
        when(fixture.dispatchService.createFollowUpTask(any(MarketEventDO.class), any(EventAutoTriggerConfigPort.EventAutoTriggerRule.class)))
                .thenReturn("task-1");
    ...
    void executePendingAutoTriggerReusesExistingTaskForIdempotency() {
        ...
        EventAutoTriggerConfigPort.EventAutoTriggerRule rule = fixture.rule("HIGH_IMPACT");
        when(fixture.configService.findEnabledRuleByCode("HIGH_IMPACT")).thenReturn(rule);
        MarketEventTaskProjection existingTask = new MarketEventTaskProjection(
                1L,
                "task-existing",
                null,
                null,
        ...
        when(fixture.marketEventTaskReadPort.selectLatestTaskBySourceEvent("MARKET_EVENT", "event-1")).thenReturn(existingTask);
    ...
    private static final class Fixture {
        ...
        private final MarketEventTaskReadPort marketEventTaskReadPort = mock(MarketEventTaskReadPort.class);
        private final StringRedisTemplate stringRedisTemplate = mock(StringRedisTemplate.class);
        private final EventAutoTriggerConfigPort configService = mock(EventAutoTriggerConfigPort.class);
        ...
        private final MarketEventAutoTriggerAttemptManager attemptManager = new MarketEventAutoTriggerAttemptManager(
                new com.quant.aiorchestrator.manager.MarketEventAutoTriggerPersistenceManager(marketEventMapper, attemptMapper),
                marketEventTaskReadPort,
                stringRedisTemplate
        );
        ...
        private EventAutoTriggerConfigPort.EventAutoTriggerRule rule(String ruleCode) {
            EventAutoTriggerConfigPort.EventAutoTriggerRule rule = new EventAutoTriggerConfigPort.EventAutoTriggerRule();
