...
public class EventAutoTaskPayloadManager {
    ...
    public Map<String, Object> buildPayload(MarketEventDO event, EventAutoTriggerConfigPort.EventAutoTriggerRule rule) {
    ...
    private String resolveTaskTitle(MarketEventDO event, EventAutoTriggerConfigPort.EventAutoTriggerRule rule) {
