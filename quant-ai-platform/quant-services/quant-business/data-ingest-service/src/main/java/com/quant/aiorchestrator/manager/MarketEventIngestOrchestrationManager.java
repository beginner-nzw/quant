...
public class MarketEventIngestOrchestrationManager {
    ...
    private final EventSourceConfigReadPort eventSourceConfigReadPort;
    ...
    public MarketEventBatchImportResultVO mockIngestMarketEvents(MarketEventMockIngestDTO dto,
        ...
        EventSourceConfigItemVO sourceConfig = eventSourceConfigReadPort.findSource(dto.getSourcePreset());
    ...
    public MarketEventBatchImportResultVO syncMarketEventSource(String sourceCode,
        ...
        EventSourceConfigItemVO sourceConfig = eventSourceConfigReadPort.findSource(sourceCode);
        if (sourceConfig == null) {
    ...
    private String buildMockSourceDetail(MarketEventMockIngestDTO dto) {
        EventSourceConfigItemVO source = eventSourceConfigReadPort.findSource(dto == null ? null : dto.getSourcePreset());
